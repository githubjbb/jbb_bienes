$( document ).ready( function () {
	...
	$(".btn-danger").click(function () {	
			...
			//Activa icono guardando
			if(window.confirm('Por favor confirmar si desea eliminar el Documento.'))
			{
					$(".btn-danger").attr('disabled','-1');
					$.ajax ({
						type: 'POST',
						url: base_url + 'equipos/delete_documento',
						...
						success: function(data){
							...
							{	                                                        
								...
								var url = base_url + "equipos/documento/" + data.idEquipo;
								$(location).attr("href", url);
							}
							else
							{
